                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MagnaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MagnaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mgn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MagnaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MagnaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MagnaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MagnaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MagnaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MagnaCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MagnaCoin Core help message to get a list with possible MagnaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MagnaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MagnaCoin network", "", count));
}
...
{
    QString strTitle = tr("MagnaCoin Core"); // default title
