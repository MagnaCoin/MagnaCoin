...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(1, uint256("000007262b0130f0bbfb439df025cf812bd651c18f6dca5678f2c4419997028d"))
        (501, uint256("000000155612a7b587b0826fc6178950d3958dedcb1b1bc171da2ab823ac1552"))
        (604, uint256("0000005385dc979b30214ee2a31543a725b3e2f48b339a2aa780c3e1867d065e"))
        (705, uint256("0000007c47fe017092a3d5764e232bbbcbeeb5897b351b23b9920fe0f61815c1"))
        (780, uint256("00000064fcefb6263e20abc48f6e08e660b32086d01a3bedf9f87218934ec68a"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1511138492, // * UNIX timestamp of last checkpoint block
    785,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0000898d3ba6ba6e7423fa5cbd6a89e0a9a5300f88d33000005cb1a8b7ed2c1000335fc8dc4f012cb8241cc0bdafd6ca70c5f5448916e4e6f511ffffffffffffff");
        nDefaultPort = 57821;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MagnaCoin starting difficulty is 1 / 2^12
        ...
        vSeeds.push_back(CDNSSeedData("45.32.238.216", "45.32.238.216"));
        vSeeds.push_back(CDNSSeedData("45.77.136.88", "45.77.136.88"));
        vSeeds.push_back(CDNSSeedData("107.191.46.225", "107.191.46.225"));
        vSeeds.push_back(CDNSSeedData("108.61.165.108", "108.61.165.108"));
        ...
        strSporkKey = "8823f2b48d99f15a0bceedbe9b05a06d028aca587c3a0f0ee4a7dff6b0859181c1225b5842a17e8bb74758b8f1757a82025631f3276bec0734c6f61de71c1e4d28";
...
public:
    CTestNetParams()
    {
        ...
        strSporkKey = "08888C2F50F90267E64FACC65BFDC9D0EB147D090872FB97ABAE92E9A36E6CA60983E28E741F8E7277B11A7479B626AC115BA31463AC48178A5075C5A9319D4A38";
